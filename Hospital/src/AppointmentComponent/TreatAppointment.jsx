...
const TreatAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    const response = await axios.get("http://localhost:6060/api/appointment/id?appointmentId="+appointmentId);
  ...
  const saveAppointment = () => {
    ...
    axios
      .post("http://localhost:6060/api/appointment/doctor/update", formData)
      .then((result) => {
